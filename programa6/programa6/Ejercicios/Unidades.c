...
//Imnprimir menu 
	...
	if(opc == 1){
		while(1){
			...
			///Imprimir valor... 
			printf("\n%f millas son %f kilometros", unit, unit*1.609);
		}
	}else if(opc == 2){
		while(1){
		//limpiar pantalla 
			...
			//Imprimir valor 
			printf("\n%f galones son %f litros", unit, unit*3.78541);
		}
	}else if(opc == 3){
		while(1){
		//Limpiar pantalla
		...
		//Imprimir valor 
			printf("\n%f pulgadas son %f centimetros", unit, unit*2.54); 
		}
	}else if(opc == 4){
		while(1){
		//Limpiar pantalla
		...
		//Imprimir valor 
			printf("\n%f pies son %f metros", unit, unit*0.3048);
		}
	}else if(opc == 5){
		system("clear");
